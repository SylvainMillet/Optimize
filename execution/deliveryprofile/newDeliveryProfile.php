<h3 style="display: none" id="titleDeliveryProfile">Delivery profile</h3>
	...
	<form class="well" style="display: none" id="formDeliveryDate">
		<legend>Capture of the delivery dates</legend>
			...
			<div class="container">
				<div class="form-group col-lg-4">
					<span class="badge">Field 51</span> <label for="duration">Duration : </label>
	...
	<form class="well" style="display: none" id="formLoadType">
		...
		<div class="container">
			<div class="form-group col-lg-4">
				...
				<label for="daysOfTheWeek">Days of the week : </label>
		...
		<div class="container">
			<div class="form-group col-lg-4">
				...
				<label for="loadDeliveryIntervals">Load Delivery Intervals : </label>
				<input id="loadDeliveryIntervals" type="text" maxlength="50" class="form-control">
			</div>
		</div>
		
		<div class="container">
			<div class="form-group col-lg-4">
				<span class="badge">Field 55</span> <label for="deliveryCapacity">Delivery Capacity
					Price : </label> <input id="deliveryCapacity" type="number" step="0.01"
					class="form-control">
			</div>
		</div>
		...
		<div class="container">
			<div class="form-group col-lg-4">
				...
				<label for="deliveryCapacityUnit">Delivery Capacity Unit : </label>
				<select id="deliveryCapacityUnit"
					class="form-control">
					<option value=null></option>
					<?php
					if($cnx){
		...
		<div class="container">
			<div class="form-group col-lg-4">
				<span class="badge">Field 57</span> <label for="priceTimeIntervalsQuantity">Price/Time Intervals Quantity : </label> <input id="priceTimeIntervalsQuantity" type="number" step="0.01"
					class="form-control">
			</div>
		</div>
